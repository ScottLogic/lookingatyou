const getNormalisedCentrePointOf = require('../src/static/js/frame_feed')
    .getNormalisedCentrePointOf;

let video_1920_1080 = { width: 1920, height: 1080 };
