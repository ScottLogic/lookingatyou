...
export const userInteraction = {
    texts: [
        ...
        { phrase: 'BRING ME A BISCUIT AND SEE WHAT WILL HAPPEN', frequency: 0.4 },
        { phrase: 'REMINDER: HAVE LUNCH', frequency: 0.1 },
        { phrase: 'YOU WOULDN\'T READ THAT IN A BOOK, WOULD YOU?', frequency: 0.1 },
        { phrase: 'MAY THE FORCE BE WITH YOU', frequency: 0.05 },
        { phrase: 'EVERY MAN HAS EYES, NOT EVERY MAN REALLY SEES', frequency: 0.05 },
        { phrase: 'YOU\'VE GOT A FRIEND IN ME', frequency: 0.05 },
        { phrase: 'DESPITE THE CONSTANT NEGATIVE PRESS COVFEFE', frequency: 0.2 },
        ...
        { phrase: 'LIFE MOVES PRETTY FAST. IF YOU DON\'T STOP AND LOOK AROUND ONCE IN A WHILE, YOU COULD MISS IT', frequency: 0.1 },
        { phrase: 'IT\'S NOT WHO I AM UNDERNEATH, BUT WHAT I DO THAT DEFINES ME', frequency: 0.1 },
        { phrase: 'YOU HAD ME AT "HELLO"', frequency: 0.05 },
        { phrase: 'WHEN YOU LOOK AT THE DARK SIDE, CAREFUL YOU MUST BE. FOR THE DARK SIDE LOOKS BACK', frequency: 0.1 },
